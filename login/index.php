...
<center>
    <img src="../public/images/login01.jpg" alt="" width="300px">
</center>
<br>
    ...
    if (isset($_SESSION['mensaje'])) {
        ...
        <script>
            Swal.fire({
                icon: "error",
                title: "Oops...",
                text: "Cargó mal Usuario o Contraseña! VUELVA A INTENTAR",
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="../../index2.html" class="h1"><b>Sistema de</b>VENTAS</a>
            </div>
            <div class="card-body">
